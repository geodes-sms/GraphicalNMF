...
public abstract class AdapterWriter implements ISTWriter
{
    ...
    @Override
    public String write(String outputDir) throws GeneratorException, URISyntaxException
    {
        String filePath;
    ...
    public abstract String getClassName() throws URISyntaxException;
     ...
     */
    protected static ST createTemplate(String name, String file) throws URISyntaxException
    {
        String str = AdapterWriter.class.getModule().getName();
        System.out.println(str);

//        URL templateFile = CodeGenerator.class.getClassLoader().getResource("../resources/main/adapter_factory.stg");
//        System.out.println(templateFile);
//        Path file1 = Paths.get(templateFile.toURI());
//        System.out.println(file1);

        STGroup factoryGroup = new STGroupFile("");
