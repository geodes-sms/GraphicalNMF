...
/**
 * Factory for StringTemplate writer for Ecore elements.
 * <br>
...
public final class EcoreWriterFactory
{
    ...
    public static AdapterFactoryWriter createAdapterFactoryWriter(EPackage pkg) throws URISyntaxException
    {
...
//        writer.addImport(apiImport);
    ...
    public static ModelAdapterWriter createModelAdapterWriter(EPackage pkg) throws URISyntaxException
    {
        String name = capitalize(pkg.getName());
...
//        writer.addImport(apiImport);
    ...
    public static NodeAdapterWriter createNodeAdapterWriter(EClass eClass) throws URISyntaxException
    {
