package geodes.sms.gnmf.generator;

import geodes.sms.gnmf.generator.writers.AdapterFactoryWriter;
import geodes.sms.gnmf.generator.writers.EcoreWriterFactory;
import geodes.sms.gnmf.generator.writers.GeneratorException;
...
public class CodeGenerator
{
    ...
    /**
     * Generate the geodes.sms.gnmf.generator.adapters for the EPackage and write it in the output directory. </br>
    ...
    private static String generateAdapters(EPackage pkg, String outputDir) throws GeneratorException
    {
        ...
        try
        {
            ...
            //Generate the node geodes.sms.gnmf.generator.adapters
